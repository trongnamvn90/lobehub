export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Tiny Hive server to enable data synchronization',
  ...
  'sync.lobehubCloud.description': 'Officially provided cloud service',
  'sync.lobehubCloud.title': 'Tiny Hive Cloud',
