export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Tiny Hive Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Tiny Hive. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Tiny Hive',
  ...
  'screen5.actions.signInCloud': 'Sign in to Tiny Hive Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Tiny Hive Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Tiny Hive Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Tiny Hive server instance',
