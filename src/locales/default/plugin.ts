export default {
  ...
  'protocolInstall.official.badge': 'Tiny Hive Official Skill',
  'protocolInstall.official.description': 'Official Tiny Hive Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Tiny Hive does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to Tiny Hive',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Tiny Hive Skills',
