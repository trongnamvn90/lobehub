export default {
  ...
  'memory.enabled.desc':
    'Allow Tiny Hive to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'skillStore.tabs.lobehub': 'Tiny Hive',
