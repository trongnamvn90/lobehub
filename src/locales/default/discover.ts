export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>admin@tinyhive.dev</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>admin@tinyhive.dev</email>.',
  ...
  'createGuide.func1.title': 'Submit in Tiny Hive',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Tiny Hive Community.',
  'footer.title': 'Share your creation on Tiny Hive Community today',
  ...
  'models.providerInfo.apiTooltip': 'Tiny Hive supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Tiny Hive Official Service',
